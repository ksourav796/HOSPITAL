    ...
    function ($scope,$http,Notification) {
        ...
        $scope.saveOrUpdateformsetup= function () {
            if (angular.isUndefined($scope.typename)||$scope.typename === '') {
                ...
                $http.post('/hospital' + '/saveformsetup', angular.toJson(saveFormSetupDetails, "Create")).then(function (response, status, headers, config) {
        ...
        $scope.editFormsetupPopulate = function (typename) {
            $http.post('/hospital' + '/editFormSetupMethod?typeName='+typename).then(function (response) {
                var data = response.data;
                $scope.formsetupId = data.formsetupId;
        ...
        $scope.saveFormsetupDesc = function(){
            ...
            $http.post('/hospital' +'/saveDescription', angular.toJson(saveDescription, "Create")).then(function (response) {
